        ...
        methods:{
                get_my_info(){
                        ...
                        axios.post('/get_my_info',{
                                ...
                                if(response.data.status===200){
                                        ...
                                        //获取信息
                                        that.my_nickname = response.data.user.nickname;
                                        that.myemail = response.data.user.email;
                                        that.my_signature = response.data.user.signature;
                                        that.my_phone =  response.data.user.phone;
                                        that.my_sex = response.data.user.sex;
                                        that.blood_type = response.data.user.blood_type;
                                        that.star_type = response.data.user.star_type;
                                        that.profile_url = response.data.user.url;
                                        that.register_time = response.data.user.gmt_create;

                                        //将信息赋值给可编辑的变量
                                        that.nickname_edit = that.my_nickname;
                                        that.sex_edit = that.my_sex;
                                        that.star_id_edit = response.data.user.star_id;
                                        that.phone_edit = that.my_phone;
                                        that.signature_edit = that.my_signature ;
                                        that.blood_type_id_edit = response.data.user.blood_type_id;
                ...
                update_my_info(){
                        ...
                        axios.post('/update_my_info',{
                                ...
                                sex:parseInt(that.sex_edit),
                                phone:that.phone_edit,
                                signature:that.signature_edit,
                                blood_type_id:parseInt(that.blood_type_id_edit),
                                star_id:parseInt(that.star_id_edit)
                        }).then(function (response){
                                if(response.data.status===200){
                ...
                get_group_messages(){
                        ...
                        for(let i=0;i<that.my_groups.length;i++){
                                axios.post('/get_group_messages',{
                                        ...
                                        if(response.data.status===200){
                                                let messages = response.data.messages;
                                                that.my_groups[i].messages = messages;//
                                                if(messages.length>0)
