...
public class IndexController {
    ...
    public Map<String,Object> updateInfo(@RequestBody Map<String,Object> map){
        ...
        Integer blood_type_id = (Integer) map.get("blood_type_id");
        Integer star_id = (Integer) map.get("star_id");
        ...
        user.setBlood_type_id(blood_type_id);
        user.setPhone(phone);
    ...
    public Map<String,Object> addFriend(@RequestBody Map<String,Object> map){
        ...
        notice.setMsg(msg);
        notice.setType(0);
        notice.setGmt_modified(new Date());
        notice.setGmt_create(new Date());
    ...
    public Map<String,Object> deleteNotice(@RequestBody Map<String,Object> map){
        ...
        notice1.setGmt_create(notice.getGmt_create());
        notice1.setGmt_modified(new Date());
        notice1.setType(2);
        noticeService.deleteById(notice.getId().toString());
    ...
    public Map<String,Object> agreeApply(@RequestBody Map<String,Object> map) {
        ...
        friend1.setGmt_create(new Date());
        friend1.setGmt_modified(new Date());

        friend2.setMe(Integer.valueOf(notice.getTo()));
        friend2.setFriend(Integer.valueOf(notice.getFrom()));
        friend2.setGmt_modified(new Date());
        friend2.setGmt_create(new Date());
    ...
    public Map<String,Object> getMessage(@RequestBody Map<String,Object> map){
        ...
        Friend f = new Friend(null,Integer.valueOf(me),Integer.valueOf(friend),new Date(),new Date());
    ...
    public Map<String,Object> sendMessage(@RequestBody Map<String,Object> map){
        ...
        Message message = new Message(null,Integer.valueOf(from),Integer.valueOf(to),content,new Date(),new Date());
